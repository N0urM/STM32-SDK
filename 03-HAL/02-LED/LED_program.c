...
void LED_voidInitLED(t_PORT cpy_port, t_PIN cpy_pin, LED_FREQ cpy_freq)
{
    ...
    {
    case LED_FREQ_2MHZ:
        GPIO_voidInitPortPinDirection(cpy_port, cpy_pin, OUTPUT_PUSH_PULL_2MHZ);
        break;
    case LED_FREQ_10MHZ:
        GPIO_voidInitPortPinDirection(cpy_port, cpy_pin, OUTPUT_PUSH_PULL_10MHZ);
        break;
    case LED_FREQ_50MHZ:
        GPIO_voidInitPortPinDirection(cpy_port, cpy_pin, OUTPUT_PUSH_PULL_50MHZ);
        break;
    default:
        break;
    }
